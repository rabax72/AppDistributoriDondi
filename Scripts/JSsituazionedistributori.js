    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for (var i = 0; i < risultati.length; i++) {
                ...
                //$('.quantProdInDist-' + risultati[i].idProdotto).append('<div class="miniFont">' + risultati[i].quantitaDistributore + ' - ' + parseJsonDateLettura(risultati[i].dataScadenza + '</div>'));
                ...
                if (dataScadenza == dataScadenzaOld && idProd == idProdottoOld) {
                    ...
                    rigaDettaglio[i - 1] = '';
                    rigaDettaglio[i] = '<div class="miniFont lottoDist' + risultati[i].idProdotto + '">' + quantitaLotto + ' - ' + dataScadenza + '</div>';
                } else {
                    if (numeroLotto == '02-01-1') {
                        numeroLotto = risultati[i].codiceLotto;
                    }
                    ...
                    rigaDettaglio[i] = '<div class="miniFont lottoDist' + risultati[i].idProdotto + '">' + risultati[i].quantitaDistributore + ' - ' + dataScadenza + '</div>';
                }
