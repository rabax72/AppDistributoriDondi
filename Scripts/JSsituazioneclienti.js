    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for (var i = 0; i < risultati.length; i++) {
                ...
                dettaglio = dettaglio + '<td align="center"><img src="http://www.giacomorabaglia.com/AppDistributoriDondi/Immagini/' + risultati[i].foto + '"><a href="#popUpStoricoVendutoDaCliente" data-rel="popup" data-position-to="window" class="storicoVendutoDaCliente" data-idProdotto="' + risultati[i].idProdotto + '"><img src="http://www.giacomorabaglia.com/AppDistributoriDondi/Immagini/info_40x40.png" border="0" alt="Storico Vendite" title="Storico Vendite"></a></td>';
